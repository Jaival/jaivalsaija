...
export default function ContactMe() {
  return (
    <section className="pb-20 bg-gray dark:bg-black-light">
      <div className="h-48 max-w-6xl mx-auto antialiased bg-gray dark:bg-black-light">
        <h1 className="py-20 text-5xl font-bold text-center md:text-9xl md:text-left">
          Contact
        </h1>
      </div>
      <div className="relative z-10 max-w-6xl p-4 mb-20 -mt-4 mx-2 md:mx-auto text-white rounded-md shadow-md bg-blue md:p-10 lg:p-20">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="md:ml-4">
            ...
            <div className="inline-flex flex-col my-20 icons-container">
              {/* <div className="flex flex-row items-center p-4 space-x-6 border rounded-md border-blue hover:border hover:border-aero">
                                <svg
            ...
            <div className="flex flex-row space-x-8 social-icons">
              <Link
                ...
                className="flex items-center justify-center w-10 h-10 rounded-md cursor-pointer hover:border hover:border-aero"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
          ...
          <form className="flex flex-col p-4 rounded-lg form dark:bg-blue">
            ...
            <input
              type="text"
              className="px-1 py-2 mx-4 mt-2 font-light border rounded-md focus:outline-none focus:ring-2 focus:border-none ring-border-aero"
              name="name"
            />
